...
echo form_open('index.php/verifyroomadd/');
?>

	<label for="id">ID: </label>
	<input type="text" size="80" id="id" name="id" value="<?php echo set_value('id'); ?>" /><br>
	<label for="shape_coords">Súradnice: </label>
	<input type="text" size="80" id="shape_coords" name="shape_coords" value="<?php echo set_value('shape_coords'); ?>" /><br>
	<label for="embedded_data">Info: </label>
	<textarea id="embedded_data" name="embedded_data" cols="80" maxlength="4000" ><?php echo set_value('embedded_data'); ?></textarea>
